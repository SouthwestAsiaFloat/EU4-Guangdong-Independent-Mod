...
ROOT = HERE.parents[2]
DEST = ROOT / 'guangdong_independent_practice/gfx/interface/zhx_gongyi_yang'
PREVIEW = ROOT / 'planning/gongyi_yang_government_art/government_icons_preview.png'
ASSETS = [('gongyi', '公邑 · 城楼与自治印信'), ('yang', '扬国 · 商船与护商刀')]
...
def main():
    ...
    draw.text((28, 20), '公邑与扬国 · 政府改革图标', font=font(25), fill='#e7d7b1')
